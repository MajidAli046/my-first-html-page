...
<body style="background-color: lightblue; font-family: Arial;">
    ...
    <h2>About Me</h2>
    <p>Hello! My name is Ahmed Ali. I am a CSC101 student. I am learning HTML in my computer science lab.</p>
    <h2>My Hobbies</h2>
    <ul>
        <li>Reading</li>
        <li>Cricket</li>
    ...
    <p>My goal is to become a skilled software developer and build useful applications.</p>
</body>
</html>
